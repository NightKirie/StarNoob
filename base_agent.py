...
class BaseAgent(base_agent.BaseAgent):
    ...
    def get_my_army_by_pos(self, obs, pos1x=0, pos1y=0, pos2x=64, pos2y=64):
        ...
        """
        army_type_list = [getattr(units.Terran, unit) for unit in MY_ARMY_LIST]
        return [unit for unit in obs.observation.raw_units
    ...
    def get_enemy_army_by_pos(self, obs, pos1x=0, pos1y=0, pos2x=64, pos2y=64):
        ...
        Returns:
            list: a list of army units
        """
        army_type_list = [getattr(units.Terran, unit) for unit in ENEMY_ARMY_LIST]
        return [unit for unit in obs.observation.raw_units
    ...
    def get_my_building_by_pos(self, obs, pos1x=0, pos1y=0, pos2x=64, pos2y=64):
        ...
        """
        building_type_list = [getattr(units.Terran, unit) for unit in MY_BUILDING_LIST]
        return [unit for unit in obs.observation.raw_units
                if unit.alliance == features.PlayerRelative.SELF
    ...
    def get_enemy_building_by_pos(self, obs, pos1x=0, pos1y=0, pos2x=64, pos2y=64):
        ...
        Returns:
            list: a list of building units
        """
        building_type_list = [getattr(units.Terran, unit) for unit in ENEMY_BUILDING_LIST]
        return [unit for unit in obs.observation.raw_units
                if unit.alliance == features.PlayerRelative.ENEMY
                    and unit.unit_type in building_type_list
                    and unit.x >= pos1x and unit.x < pos2x
