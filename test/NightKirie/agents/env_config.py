...
flags.DEFINE_bool("battle_net_map", False, "Whether to use the battle.net versions of the map(s)")
...
flags.DEFINE_bool("discount_zero_after_timeout", False, "If True, the discount will be zero after the 'game_steps_per_episode' timeout")

flags.DEFINE_bool("visualize", False, "Whether to pop up a window showing the camera and feature layers.")
...
flags.DEFINE_string("replay_dir", None, "Directory to save replays. Required with save_replay_episodes.")

flags.DEFINE_string("replay_prefix", None, "An optional prefix to use when saving replays.")
...
flags.DEFINE_integer("score_multiplier", None, "How much to multiply the score by. Useful for negating.")
