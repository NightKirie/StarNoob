...
if "flags_defined" not in globals():
    ...
    flags.DEFINE_integer("game_steps_per_episode", None,
                         "Game steps per episode.")
    ...
    flags.DEFINE_bool("save_replay", True,
                      "Whether to save a replay at the end.")
...
def main(unused_argv):
    ...
    if map_inst.players >= 2:
        if FLAGS.agent2 == "Bot":
            ...
            agent_cls = getattr(
                importlib.import_module(agent_module), agent_name)
            agent_classes.append(agent_cls)
